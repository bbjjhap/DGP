...
from gpytorch.mlls import VariationalELBO, AddedLossTerm, GammaRobustVariationalELBO
...
class DeepGP(DeepGP):
    def __init__(self, train_x_shape):
        ...
        hidden_layer5 = ToyDeepGPHiddenLayer(
            input_dims=hidden_layer4.output_dims,
            output_dims=num_output_dims,
            mean_type='constant',
        )
        ...
        hidden_layer7 = ToyDeepGPHiddenLayer(
            input_dims=hidden_layer6.output_dims,
            output_dims=num_output_dims,
            mean_type='constant',
        )
        ...
        hidden_layer9 = ToyDeepGPHiddenLayer(
            input_dims=hidden_layer8.output_dims,
            output_dims=num_output_dims,
            mean_type='constant',
        )
        ...
        hidden_layer11 = ToyDeepGPHiddenLayer(
            input_dims=hidden_layer10.output_dims,
            output_dims=num_output_dims,
            mean_type='constant',
        )

        hidden_layer12 = ToyDeepGPHiddenLayer(
            input_dims=hidden_layer11.output_dims,
            output_dims=num_output_dims,
            mean_type='constant',
        )
        hidden_layer13 = ToyDeepGPHiddenLayer(
            input_dims=hidden_layer12.output_dims,
            output_dims=num_output_dims,
            mean_type='constant',
        )
        hidden_layer14 = ToyDeepGPHiddenLayer(
            input_dims=hidden_layer13.output_dims,
            output_dims=num_output_dims,
            mean_type='constant',
        )

        last_layer = ToyDeepGPHiddenLayer(
            input_dims=hidden_layer14.output_dims,
            output_dims=None,
            mean_type='constant',
        )
        ...
        self.hidden_layer12 = hidden_layer12
        self.hidden_layer13 = hidden_layer13
        self.hidden_layer14 = hidden_layer14
    ...
    def forward(self, inputs):
        ...
        hidden_rep5 = self.hidden_layer5(hidden_rep4)
        hidden_rep6 = self.hidden_layer6(hidden_rep5)
        hidden_rep7 = self.hidden_layer7(hidden_rep6)
        hidden_rep8 = self.hidden_layer8(hidden_rep7)
        hidden_rep9 = self.hidden_layer9(hidden_rep8)
        hidden_rep10 = self.hidden_layer10(hidden_rep9)
        hidden_rep11 = self.hidden_layer11(hidden_rep10)
        hidden_rep12 = self.hidden_layer12(hidden_rep11)
        hidden_rep13 = self.hidden_layer13(hidden_rep12)
        hidden_rep14 = self.hidden_layer14(hidden_rep13)
        output = self.last_layer(hidden_rep14)
        return output
...
mll = DeepApproximateMLL(GammaRobustVariationalELBO(model.likelihood, model, num_data=train_x.shape[-2]))
...
time12 = time.strftime("%Y-%m-%d %H:%M:%S",time.localtime())
file_name = 'DGP_ScaleRBF_15layer_Delta_Gamma_Epoch20'
