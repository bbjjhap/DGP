...
class DeepGP(DeepGP):
    def __init__(self, train_x_shape):
        ...
        hidden_layer13 = ToyDeepGPHiddenLayer(
            input_dims=hidden_layer12.output_dims+ train_x_shape[-1],
            output_dims=num_output_dims,
            mean_type='constant',
        )
    ...
    def forward(self, inputs):
        ...
        hidden_rep13 = self.hidden_layer13(hidden_rep12,inputs)
...
time12 = time.strftime("%Y-%m-%d %H:%M:%S",time.localtime())
file_name = 'DGP_ScaleRBF_15layer_Delta_Gamma_short_Epoch20'
